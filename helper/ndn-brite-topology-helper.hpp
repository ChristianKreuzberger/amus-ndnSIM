...
#ifndef NDN_BRITE_TOPOLOGY_HELPER_H
#define NDN_BRITE_TOPOLOGY_HELPER_H
...
class NDNBriteTopologyHelper
{
public:
  /**
   * Construct a NDNBriteTopologyHelper
   *
   ...
   */
  NDNBriteTopologyHelper (std::string confFile,
                       std::string seedFile,
                       std::string newseedFile);

  /**
   * Construct a NDNBriteTopologyHelper using NS3 to generate seed values
   * need by BRITE
   *
   */
  NDNBriteTopologyHelper (std::string confFile);

  ~NDNBriteTopologyHelper ();
