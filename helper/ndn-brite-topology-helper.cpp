...
#include "ndn-brite-topology-helper.hpp"

#include <iostream>
#include <fstream>

NS_LOG_COMPONENT_DEFINE ("NDNBriteTopologyHelper");

namespace ns3 {
namespace ndn {

NDNBriteTopologyHelper::NDNBriteTopologyHelper (std::string confFile,
                                          std::string seedFile,
...
NDNBriteTopologyHelper::~NDNBriteTopologyHelper ()
{
  NS_LOG_FUNCTION (this);
  delete m_topology;
...
void
NDNBriteTopologyHelper::AssignStreams (int64_t streamNumber)
{
  m_uv->SetStream (streamNumber);
}

void
NDNBriteTopologyHelper::BuildBriteNodeInfoList (void)
{
  NS_LOG_FUNCTION (this);
...
void
NDNBriteTopologyHelper::BuildBriteEdgeInfoList (void)
{
  NS_LOG_FUNCTION (this);
  brite::Graph *g = m_topology->GetGraph ();
...
uint32_t
NDNBriteTopologyHelper::GetNNodesForAs (uint32_t asNum)
{
  return m_nodesByAs[asNum]->GetN ();
}

uint32_t
NDNBriteTopologyHelper::GetNLeafNodesForAs (uint32_t asNum)
{
  return m_asLeafNodes[asNum]->GetN ();
}

uint32_t
NDNBriteTopologyHelper::GetNNodesTopology () const
{
  return m_numNodes;
}

uint32_t
NDNBriteTopologyHelper::GetNEdgesTopology () const
{
  return m_numEdges;
}

uint32_t
NDNBriteTopologyHelper::GetNAs (void) const
{
  return m_numAs;
}

uint32_t
NDNBriteTopologyHelper::GetSystemNumberForAs (uint32_t asNum) const
{
  return m_systemForAs[asNum];
}

void NDNBriteTopologyHelper::GenerateBriteTopology (void)
{
...
void
NDNBriteTopologyHelper::BuildBriteTopology ()
{
  NS_LOG_FUNCTION (this);
...
void
NDNBriteTopologyHelper::BuildBriteTopology (const uint32_t systemCount)
{
  NS_LOG_FUNCTION (this);
  ...
  //create nodes
  for (NDNBriteTopologyHelper::BriteNodeInfoList::iterator it = m_briteNodeInfoList.begin (); it != m_briteNodeInfoList.end (); ++it)
    {
...
void
NDNBriteTopologyHelper::ConstructTopology ()
{
  NS_LOG_FUNCTION (this);
  ...
  for (NDNBriteTopologyHelper::BriteEdgeInfoList::iterator it = m_briteEdgeInfoList.begin (); it != m_briteEdgeInfoList.end (); ++it)
    {
      // Set the link delay
