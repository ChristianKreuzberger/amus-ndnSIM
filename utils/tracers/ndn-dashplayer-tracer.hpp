 ...
 */
class DASHPlayerTracer : public SimpleRefCount<DASHPlayerTracer> {
public:
  /**
   ...
   */
  DASHPlayerTracer(shared_ptr<std::ostream> os, Ptr<Node> node);
   ...
   */
  DASHPlayerTracer(shared_ptr<std::ostream> os, const std::string& node);
