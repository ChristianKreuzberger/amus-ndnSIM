...
ckreuz@ckreuzbe-Klu-Ub1404:~/ndnSIM/amus-ICN15/scenarios$ ^C
ckreuz@ckreuzbe-Klu-Ub1404:~/ndnSIM/amus-ICN15/scenarios$ ^C
ckreuz@ckreuzbe-Klu-Ub1404:~/ndnSIM/amus-ICN15/scenarios$ ^C
ckreuz@ckreuzbe-Klu-Ub1404:~/ndnSIM/amus-ICN15/scenarios$ ls
dash_fixed_top.cc  hello.cpp  ndn-adaptive-streaming-test.cpp  ndn-file-simple.cpp  ndn-multimedia-svc.cpp          ndn-multimedia-tracing.cpp  README.md
disabled           lte.cpp    ndn-adaptive-streaming-wifi.cpp  ndn-multimedia.cpp   ndn-multimedia-svc-tracing.cpp  ndn-mysimple.cpp
ckreuz@ckreuzbe-Klu-Ub1404:~/ndnSIM/amus-ICN15/scenarios$ cat ndn-multimedia-svc.cpp
#include "ns3/core-module.h"
#include "ns3/network-module.h"
#include "ns3/point-to-point-module.h"
#include "ns3/ndnSIM-module.h"
